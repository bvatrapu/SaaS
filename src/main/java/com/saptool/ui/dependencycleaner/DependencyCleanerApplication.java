...
//            + "1. Drag-and-drop the pom.xml into the area below." + "<br>"
            + "1. Press 'Resolve' to resolve the dependencies "
            + "of the POM" + "<br>"
            + "2. See the dependency structure of the POM, and invalid "
            + "JAR files being highlighted in the table." + "<br>"
            + "3. Press 'Remove selected' to remove the JAR files that are "
            + "marked for removal in the table." + "<br>"
            + "4. Press 'Resolve' again to download fresh copies of the "
...
//        inputPanel.add(pomDropLabel);
        ...
        acceptPomFiles(new File(GlobalConstants.SELECTED_PROJECT_PATH + File.separator + "pom.xml"));
    ...
    private void acceptPomFiles(File pomPath)
    {
        loadPomInBackground(pomPath.toPath());
    }
